...
- Updated the logger-adapter dependency so task host logging uses the current shared adapter release.
...
- Replaced local config normalization, time, and package metadata helpers with shared utilities.
